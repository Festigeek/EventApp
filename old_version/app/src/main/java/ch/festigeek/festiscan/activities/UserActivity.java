...
public class UserActivity extends AppCompatActivity implements IConstant, IKeys, IURL {
    ...
    private void checkIn(int value) {
        ...
        }, getString(R.string.token), BASE_URL + CHECK_IN + mUser.getInscriptionId(), map).execute();
    }
    ...
    private void init() {
        ...
        new RequestGET(new ICallback<String>() {
            ...
            public void success(String result) {
                try {
                    ...
                    mUser = new User(getApplicationContext(), obj.getJSONObject(KEY_USER), UserActivity.this);
        ...
        }, getString(R.string.token), BASE_URL + USER_BY_ID + mId).execute();
    }
